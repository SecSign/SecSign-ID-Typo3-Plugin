                ...
                <div id="content">
                    <div class="login-form-container">
                        <div id="login-form" class="login-form">
                                <form id="secsignid-qrcode-form" method="post" style="display:none">
                                    ...
                                    <input type="hidden" name="secsign_method" id="secsign_checkQRCode" value="secsign_checkQRCode"/>
                                ...
                                <div id="secsign-qrcode" style="display: block;">
                                    ...
                                    <div class="center">
                                        ...
                                        <div class="center-item">
                                            <a id="qrcode-desktop-url" class="link" target="_blank" href="{createurl}">
                                    ...
                                    <div id="secsign-qr-code-last-step-create">

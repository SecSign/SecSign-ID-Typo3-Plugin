        ...
        <div id="content">
            <div class="login-form-container ">
                <div class="login-form">
                    <h1 id="title" style="margin-bottom:0px;"><f:translate key="LLL:EXT:secsign/Resources/Private/Language/locallang.xlf:secsignid.login.methodselect.default.title"/></h1>
                    <p id="description"><f:translate key="LLL:EXT:secsign/Resources/Private/Language/locallang.xlf:secsignid.login.methodselect.default.subtitle"/></p>

                    <form id="selection-form" method="POST">
                        <input id="selected-method" type="hidden" name="selected-method" value="none">
                        <input type="hidden" name="secsign_method" value="secsign_change_to">
                        <input type="hidden" name="secsign_username" value="{secsign_username}">
                        <input type="hidden" name="toConfirm" value="{toConfirm}">
                        ...
                        <div >
                            <div id="dialog-select">
                                <div class="column">
                                    ...
                                    <f:if condition="{new}">
                                        <div id="method-active-new" class="column method-item-be selectable-item">
                                            <h1><f:translate key="LLL:EXT:secsign/Resources/Private/Language/locallang.xlf:secsignid.login.methodselect.new.title"/></h1>
                                            <p><f:translate key="LLL:EXT:secsign/Resources/Private/Language/locallang.xlf:secsignid.login.methodselect.new.description"/></p>
                                        </div>
                                    </f:if>
                                </div>    
                    ...
                    <form id="back-form" method="POST">
                        <input type="hidden" name="secsign_method" value="secsign_back_from_change_to">
                        <input type="hidden" name="secsign_username" value="{secsign_username}">
                        <input type="hidden" name="toConfirm" value="{toConfirm}">
                        <input type="hidden" name="returnURL" value="{RETURN_URL}" />
    ...
    <script>
        $(document).ready(function (event) {   
           ...
           $(".typo3-login").css('position','relative');
            ...
            $("#method-active-new").click(function()
            {
                $("#selected-method").val('new');
                $("#selection-form").submit();
            });
